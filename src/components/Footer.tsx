...
const Footer: React.FC<FooterProps> = ({
  brand = {
    name: "ANDREA S.B.",
    shortName: "Andrea Sánchez Blanco",
    description: "Senior Software Engineer specializing in frontend and fullstack development. Based in Munich, Germany.",
    logoGradient: "from-green-400 to-green-600"
  },
  contact = {
  ...
  social = {
    linkedin: "https://www.linkedin.com/in/asblanco/",
    github: "https://github.com/asblanco"
  },
  navigation = [
  ...
  legal = {
    copyrightName: "Andrea Sánchez Blanco",
    links: [
