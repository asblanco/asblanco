          ...
          >
            <div className="text-left max-w-md">
              ...
              <div className="flex items-center space-x-4">
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/asblanco/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-900 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors">
                ...
                {/* Email */}
                <a href="mailto:contact@asblanco.com" className="w-8 h-8 bg-gray-900 rounded-full flex items-center justify-center hover:bg-red-600 transition-colors">
                  <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
                ...
                {/* Medium */}
                <a href="https://medium.com/@andreasanchezblanco" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-900 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors">
                  <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
                ...
                {/* GitHub */}
                <a href="https://github.com/asblanco" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-gray-900 rounded-full flex items-center justify-center hover:bg-purple-600 transition-colors">
                  <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
